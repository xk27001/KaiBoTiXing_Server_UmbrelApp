...
```text
ghcr.io/xk27001/kai-bo-ti-xing:1.0.5-umbrel
```
...
```bash
docker build -f kaibotixing-server/Dockerfile -t ghcr.io/<owner>/kai-bo-ti-xing:1.0.5-umbrel .
docker push ghcr.io/<owner>/kai-bo-ti-xing:1.0.5-umbrel
```
